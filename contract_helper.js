...
exports.createApp = async function (client, accountInfo, numLocalInts, numLocalByteSlices, numGlobalInts, numGlobalByteSlices, appArgs) {
...
exports.callAppWithPayment = async function (client, mnemonic, appId, appArgs, amount) {
    ...
    console.log('Awaiting confirmation (this will take several seconds)...');
    const roundTimeout = 2;
    const callAppWithPayment = await utils.waitForConfirmation(client, txId, roundTimeout);
